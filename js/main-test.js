$(function () {
    ...
    $('.btn-ditap-print').on("click", function (e) {
        ...
        var printContent = $(this).closest('.recipe-print').printThis({
            importCSS: false,
            importStyle: true,
            loadCSS: 'B4Components/css/ditap-print.css',
            debug: false
        });
    });
    ...
    $('.btn-ditap-print-invoice').on("click", function (e) {
        ...
        $('.invoice-print').printThis({
            importCSS: false,
            importStyle: false,
            loadCSS: 'B4Components/css/main.css',
            debug: false
        });
    });
    ...
    function initMMenu(mmenuElem) {
        return mmenuElem.mmenu({
            ...
            offCanvas: true,
            navbar: {
                title: "<img src=\"B4Components/media/B4Components/logos/logo_ditap.svg\" alt=\"Dita P.\"/>"
            },
            wrappers: ["bootstrap4"],
            extensions: [
                "fullscreen",
